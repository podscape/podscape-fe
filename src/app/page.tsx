        ...
        return (
            <div className="min-h-[calc(100vh-64px)] flex flex-col items-center justify-center p-8 relative">
                ...
                <span className="relative z-10 bg-clip-text text-transparent bg-gradient-to-r from-[var(--gradient-start)] to-[var(--gradient-end)]">
                    ...
                    <span className="absolute -bottom-2 left-0 w-full h-1 bg-gradient-to-r from-[var(--gradient-start)] to-[var(--gradient-end)] transform -rotate-1 opacity-75"></span>
                </h1>
                    ...
                    {PODCAST_STORIES.map((story) => (
                        ...
                        >
                            ...
                            <div className="p-6 relative z-10">
                                ...
                                <div className="mt-4 flex items-center text-[var(--secondary)] text-sm font-medium group-hover:text-[var(--primary)] transition-colors duration-300">
                                    Listen to story
                                    <svg
                            ...
                            <div className="absolute inset-0 opacity-0 group-hover:opacity-100 transition-opacity duration-300 pointer-events-none">
                                <div className="absolute inset-x-0 h-[1px] top-0 bg-gradient-to-r from-transparent via-[var(--primary)] to-transparent" />
                                <div className="absolute inset-x-0 h-[1px] bottom-0 bg-gradient-to-r from-transparent via-[var(--secondary)] to-transparent" />
                                <div className="absolute inset-y-0 w-[1px] left-0 bg-gradient-to-b from-[var(--primary)] to-[var(--secondary)]" />
                                <div className="absolute inset-y-0 w-[1px] right-0 bg-gradient-to-b from-[var(--primary)] to-[var(--secondary)]" />
                            </div>
                        </Link>
                    ))}
                </div>
